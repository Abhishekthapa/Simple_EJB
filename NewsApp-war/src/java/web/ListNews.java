    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            for (Iterator it = news.iterator(); it.hasNext();) {
                ...
                out.println("<div class='container' id="+ elem.getId()+" style='padding: 10px'>");
                out.println(" <b>"+elem.getTitle()+" </b><br />");
                out.println(elem.getBody()+"<br /> ");
                out.println("<a href='update?id=" +elem.getId()+ "'>Update</a>  ");
                out.println("<a href='delete?id=" +elem.getId()+ "'>Delete</a>");
                out.println("</div>");
            }
